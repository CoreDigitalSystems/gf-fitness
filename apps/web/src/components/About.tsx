import { IconTarget, IconTrophy, IconUsers } from './Icons'
...
const PILLARS = [
  {
    icon: IconUsers,
    title: 'Community',
    desc: "We remember your name. You find your people. Progress compounds when you're not alone.",
  },
  {
    icon: IconTarget,
    title: 'Excellence',
    desc: 'Pro-level equipment, credentialed coaches, spotless floors. No corners cut, ever.',
  },
  {
    icon: IconTrophy,
    title: 'Results',
    desc: 'Programs built around measurable progress — strength, composition, mobility, endurance.',
  },
]
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10 border border-white/10">
          {PILLARS.map((p, i) => (
            <div key={p.title} className="bg-black p-10 text-center">
              <div className="mx-auto h-16 w-16 rounded-full bg-gf-blue/10 border border-gf-blue/30 flex items-center justify-center text-gf-blue mb-6">
