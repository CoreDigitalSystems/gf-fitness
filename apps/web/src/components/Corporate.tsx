...
import { IconArrow, IconCheck, IconHandshake } from './Icons'
...
const CorpStat = ({ n, label }: { n: string; label: string }) => (
  <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/80 hover:border-white hover:bg-white hover:text-black text-white font-semibold px-6 py-3 text-sm tracking-wide transition-all"
            >
          ...
          <div className="bg-[#0a0a0a] border border-white/10 p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              <IconHandshake className="h-6 w-6 text-gf-blue" />
            ...
            <ul className="space-y-4">
              {CORP_BENEFITS.map((b) => (
                <li key={b} className="flex items-center gap-4 py-3 border-b border-white/5 last:border-0">
                  <span className="h-6 w-6 rounded-full bg-gf-blue flex items-center justify-center shrink-0">
