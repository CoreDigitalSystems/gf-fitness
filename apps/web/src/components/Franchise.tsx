...
export default function Franchise() {
  return (
    <section id="franchise" className="bg-gf-blue py-24 lg:py-32 relative overflow-hidden">
      <div
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-10 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            to="/franchise"
            className="inline-flex items-center justify-center gap-3 rounded-full border-2 border-white hover:bg-white hover:text-gf-blue text-white font-semibold px-10 py-5 text-base uppercase tracking-[0.15em] transition-all"
          >
