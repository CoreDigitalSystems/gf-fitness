...
export const BtnFilled = ({ children, className = '', ...rest }) => (
  <button
    className={`inline-flex items-center justify-center gap-2 rounded-full bg-gf-blue hover:bg-gf-dark-blue text-white font-semibold px-6 py-3 text-sm tracking-wide transition-colors ${className}`}
    {...rest}
  >
    {children}
  </button>
...
export const SectionLabel = ({ children, color = 'text-gf-blue' }) => (
