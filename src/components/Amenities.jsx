...
const AmenityCard = ({ a, i }) => {
  ...
  return (
    <div
      ref={ref}
      className="group relative bg-[#0a0a0a] border border-white/10 p-8 transition-all duration-300 hover:border-[#4B5EFF]/60 hover:-translate-y-1"
      style={{
        opacity: visible ? 1 : 0,
    ...
    >
      <div className="flex items-start justify-between mb-8">
        <div className="h-14 w-14 rounded-lg bg-[#4B5EFF]/10 border border-[#4B5EFF]/30 flex items-center justify-center text-[#4B5EFF] group-hover:bg-[#4B5EFF] group-hover:text-white transition-colors">
      ...
      <div className="mt-6 flex items-center gap-2 text-[#4B5EFF] opacity-0 group-hover:opacity-100 transition-opacity text-xs font-semibold uppercase tracking-wider">
